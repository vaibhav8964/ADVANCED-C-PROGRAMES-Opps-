...
{ private:	
  ...
  public:
  	profile()
  	{
  		cout<<"Constructor of profile is runnng"<<endl;
  		strcpy(name,"nothing");
  		roll_no=0;
	}
  	void getdata()
...
class address
{
  ...
  public:
  	address()
  	{ cout<<"CONSTRUCTOR OF ADDRESS  IS RUNNING"<<endl;
  		strcpy(city,"nothing");
  		house_no=0;
	}
  	void getdata()
...
class student: public profile,protected address
{
	private:	
    char gender;
    int adm_no;
  public:
  	student()
  	{
  		cout<<"THE CONSTRUCTR OF STUDENT IS RUNNING"<<endl<<endl;
  		cout<<"********************************"<<endl;
		gender='A';
  		adm_no=0;
	}
